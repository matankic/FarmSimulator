            ...
            try
            {
                ...
                if (price > 0)
                {
                    if (Chicken_radio.Checked == true)
                    {
                        ...
                        {
                            _credit += cnt_chicken * sell_chicken;
                            cnt_chicken = 0;
                            lbl_1.Text = cnt_chicken.ToString();
